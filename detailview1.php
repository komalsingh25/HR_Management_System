...
<?php
	...
	if(isset($_GET['candidateid']))
	{
		...
		$view = mysqli_query($db,"select * from candidate where CandId='$candid'");
	...
	{
		echo "<script>window.location='employeeview.php?candid=$candid';</script>";
	}
	else if(isset($_POST['edit']))
	{
		echo "<script>window.location='employeeadd.php?candid=$candid';</script>";	
	}
...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Tables<i class="fa fa-angle-right"></i>Candidate View<i class="fa fa-angle-right"></i>Detail View</li>
</ol>
<form method="post">
<div class="validation-form" style="margin-top: 0;">
	<h2 style="text-transform: capitalize; margin: 0px;"><?php if($row) { echo $row['FirstName']."&nbsp;".$row['MiddleName']."&nbsp".$row['LastName'];} else { echo "Null"; } ?> -&nbsp;&nbsp;<font color="black"><?php if($row>0) { echo "Candidate ID :: &nbsp;&nbsp;".$row['CandidateId']; } else { echo "<b>Employee ID</b> :: &nbsp;&nbsp; Null"; }?></font></h2>
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
