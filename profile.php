...
<?php
	...
	$positionn = "";
	$rolen ="";
	$ProfileCandId=$_SESSION['User']['CandidateId'];
	$view = mysqli_query($db,"select * from candidate where CandidateId='$ProfileCandId'");
...
<div class="validation-form" style="margin-top: 0;">
	<h2 style="text-transform: capitalize; margin: 0px;"><?php if($row) { echo $row['FirstName']."&nbsp;".$row['MiddleName']."&nbsp".$row['LastName'];} else { echo "Null"; } ?> -&nbsp;&nbsp;<font color="black"><?php if($row>0) { echo "Employee ID ::&nbsp;".$row['CandidateId']; } else { echo "<b>Employee ID</b> ::&nbsp; Null"; }?></font></h2>
	<div class="row">
		<div class="col-md-5">
			<table>
				<tbody>
