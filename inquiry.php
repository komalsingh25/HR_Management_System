...
<?php
  ...
  $inquiry = mysqli_query($db,"SELECT i.*,e.FirstName,e.LastName FROM inquiry i JOIN candidate e on i.CandId=e.CandidateId");
  if(isset($_GET['id']))
  {
    $id = $_GET['id'];
...
<div class="row" style="margin-right: 0; margin-left: 0;">
  ...
  <div class="col-md-1">
    <h5><?php echo(isset($row['CandId']))?$row['CandId']:"";?></h5>
  </div>
  <div class="col-md-2">
