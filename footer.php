						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="#"><i class="fa fa-user"></i><span>Candidate</span><span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
											<ul>
												<li><a href="employeeadd.php">Add Candidate</a></li>
												<li><a href="employeeview.php">Candidate View</a></li>
												<!-- <li><a href="atten.php">Attendece Details</a></li>
												<li><a href="modifiedlogout.php">Modified Logout Time</a></li>
												<li><a href="inquiry.php">Inquiry</a></li> -->
											</ul>
										</li>
										<li><a href="leaverequest.php"><i class="fa fa-pagelines"></i><span>Applications</span></a>
